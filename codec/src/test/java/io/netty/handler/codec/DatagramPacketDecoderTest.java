...
public class DatagramPacketDecoderTest {
    ...
    public void testNotSharable() {
        MessageToMessageDecoder<ByteBuf> wrapped = new TestMessageToMessageDecoder(false);
    ...
    public void testSharable() {
        MessageToMessageDecoder<ByteBuf> wrapped = new TestMessageToMessageDecoder(true);
        DatagramPacketDecoder decoder = new DatagramPacketDecoder(wrapped);
        assertEquals(wrapped.isSharable(), decoder.isSharable());
    }
